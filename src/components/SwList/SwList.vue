<template>
  <Popper :placement="placement">
    ...
    <template #content="{ close }">
      <div class="bg-white rounded-md shadow-md dark:bg-zink-600 dropdown-menu">
        <ul
          ref="list"
          class="transition-[height] duration-200 bg-white z-50dropdown-menu min-w-[10rem] text-left rounded-md dropdown-menu flex flex-col dark:bg-zink-600"
          :class="{
...
import { ListMenuItemType } from "./types";
