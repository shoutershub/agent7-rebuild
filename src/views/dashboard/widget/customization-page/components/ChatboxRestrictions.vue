              ...
              <template #default>
                ...
                >
                  <div class="block text-left">
                    ...
                    <ul
                      class="h-48 p-3 pt-0 space-y-1 overflow-y-auto text-sm text-gray-700 dark:text-gray-200"
                    ...
                    >
                      ...
                      >
                        <label
                          ...
                          class="w-full text-sm font-medium text-gray-900 rounded cursor-pointer dark:text-gray-300"
                        >
                          <div class="flex items-center rounded">
                            <input
                              ...
                              "
                              :value="item.code"
                              class="w-4 h-4 mr-2 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                            />
                            {{ item.name }}
                          </div>
                        </label>
