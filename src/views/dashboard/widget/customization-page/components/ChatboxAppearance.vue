            ...
            <template #default>
              ...
              >
                <div class="block">
                  ...
                  >
                    <div
                      class="inline-block w-full p-2 pl-4 text-xs font-medium text-gray-800 border-0 cursor-pointer hover:bg-gray-200 dark:bg-gray-700"
                    >
                      <div class="flex items-center">
                        <span
                          class="w-[15px] h-[15px] mr-2 rounded-full"
      ...
      <div class="w-[50%]">
        <div class="text-right">
          ...
          >
            <template #title>
              <div class="flex items-center">
                <div class="overflow-hidden text-sm text-gray-600 whitespace-nowrap text-ellipsis">
