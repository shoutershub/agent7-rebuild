          ...
          >
            <form class="lg:pr-3" action="#" method="GET">
              ...
              <div class="relative mt-1 lg:w-64 xl:w-96">
                <sw-input
                  ...
                  name="email"
                  id="users-search"
                  class="block w-full text-gray-900 rounded-lg bg-gray-50 sm:text-sm focus:ring-primary-500 focus:border-primary-500"
            ...
            <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
              <sw-button
                ...
                class="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer disabled:cursor-not-allowed hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <delete-icon
        ...
        >
          ...
          <sw-table-body>
            <sw-table-row v-for="(item, index) in items" :key="index">
              ...
              <sw-table-cell class="flex items-center justify-end px-4 py-3">
                <button
                  type="button"
                  :key="index"
                ...
                <!-- <sw-dropdown button-color="transparent" :showDropDownArrow="false" :closeInside="true">
                  ...
                  <div
                  class="z-10 bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
                >
                  <ul
      ...
      <template #footer>
        ...
        >
          ...
          <div class="text-sm text-gray-500">
            ...
            <span class="inline-flex text-blue-500 cursor-pointer">
